...
public class UserDetailsRestController {
  ...
  @GetMapping("/nickname")
  public String getUserNickName(@RequestParam("uuid") String uuid) {
    return userDetailsService.getUserNickName(uuid);
  }

  @PostMapping(value = "/create")
  public CreateUserDetailsResponse createUser(@RequestBody UserDetailsRequest userDetailsRequest) {
